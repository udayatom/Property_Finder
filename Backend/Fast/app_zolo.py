...
app = FastAPI()
db_path = os.path.join('..', 'DB', 'Zolo.db')
...
async def find(query: NLPQuery):
    ...
    myobj = {"model": "llama3", "stream": False, "prompt": "'''Your name is Swetha, your role is real estate assistant. You have to summarized answer "
    ...
    if len(latlong) > 1:
        ...
        url = 'http://127.0.0.1:8003/filter'
        print("latitid")
